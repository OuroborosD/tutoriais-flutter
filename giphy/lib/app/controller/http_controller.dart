...
class GifController {
  GifController([this.offset, this.search]);
  String? search;
  int? offset;
  ...
  Future<List<String>> get_Gif([int? offset, String? search]) async {
    ...
    if (this.search == null || this.search!.isEmpty) {
      ...
      request = Uri.parse(
          "https://api.giphy.com/v1/gifs/search?api_key=xX2ZYCWebdiWuESJQQ6wOjB5JxkSZrLG&q=${this.search}&limit=19&offset=0&rating=r&lang=en");
    }
